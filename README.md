...
The command above exports the latest checkpoint in the model directory. To export a particular checkpoint, add the following option:

```sh
  --gin_param="utils.run.export_checkpoint_step = 100000"
```
